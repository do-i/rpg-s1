...
| RK-PTY-004 | `SET-PARTY` | Open Items and visit All, New, Recovery, Status, Battle, Material, Core, and Key tabs. | Each pouch visibly contains only matching shared-inventory rows; the original-style Pouch, Items, and Detail columns remain readable for empty and multi-page lists. | Tab/filter/scroll navigation does not change quantities. | M6.06-M6.10, M6.27 / Gate 6 | Pass — production-catalog fixture plus X11 screen 2026-08-12; three-column UI structure regression 2026-08-16 |
